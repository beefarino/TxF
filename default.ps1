...
properties {
	$config = 'Debug'; 	
	$slnFile = @(
		'./src/CodeOwls.TxF.sln'
	);	
    $targetPath = "./src/CodeOwls.TxF/bin";
    
    $moduleName = "TxF";
	$moduleSource = "./src/Modules";
    $metadataAssembly = 'CodeOwls.TxF.dll'
    $currentReleaseNotesPath = '.\src\Modules\TxF\en-US\about_TxF_Version.help.txt'
};
